...
// Class definitions moved outside the component hook to avoid closure and re-creation overhead
class CommonClass {
  constructor() {
    this.width = 0;
    this.height = 0;
...
class ExternalForce extends ShaderPass {
  ...
  dispose() {
    super.dispose();
    if (this.mouseMesh) {
      if (this.mouseMesh.geometry) this.mouseMesh.geometry.dispose();
      if (this.mouseMesh.material) this.mouseMesh.material.dispose();
    }
  }
}
