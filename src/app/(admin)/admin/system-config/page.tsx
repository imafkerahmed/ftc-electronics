...
import { Settings2, Store, Printer, Palette, ChevronRight, ArrowRight, Users } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-2">
        ...
        {/* Card: Employees */}
        <Link
          href="/admin/system-config/employees"
          className="group bg-card border border-border hover:border-indigo-500/50 hover:shadow-lg hover:shadow-indigo-500/5 transition-all duration-200 rounded-2xl p-6 flex flex-col justify-between space-y-6 cursor-pointer"
        >
          <div className="space-y-4">
            <div className="flex items-center justify-between">
            ...
            <div>
              <h2 className="text-base font-bold text-foreground group-hover:text-indigo-500 transition-colors">
                POS Employees
              </h2>
              <p className="text-xs text-muted-foreground mt-1.5 leading-relaxed">
                Add and manage cashier and manager accounts for the in-store POS system with PIN-based login.
              </p>
            </div>
          </div>
          <div className="pt-2 border-t border-border/60 flex items-center justify-between text-xs font-semibold text-indigo-600 dark:text-indigo-400">
