...
import { Settings2, Store, Printer, ChevronRight, FileText, ArrowRight } from 'lucide-react';
      ...
      <div className="border-b border-border pb-5">
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Select a configuration category below to manage store settings and printing layouts.</p>
          </div>
        </div>
      </div>
        ...
        >
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1.5 leading-relaxed">
                Configure barcode sticker label sizes, column grids, and 80mm/58mm thermal POS receipt formats with instant test printing.
              </p>
            </div>
          </div>
          <div className="pt-2 border-t border-border/60 flex items-center justify-between text-xs font-semibold text-emerald-600 dark:text-emerald-400">
            <span>Configure Labels & Thermal Receipts</span>
            <ArrowRight className="h-3.5 w-3.5 group-hover:translate-x-1 transition-transform" />
          </div>
        </Link>
